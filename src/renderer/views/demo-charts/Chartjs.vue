  ...
  div
    .tile.is-ancestor
      ...
      .tile.is-parent.is-4
        article.tile.is-child.box
          h4.title POLAR
          chart(:type="'polarArea'", :data='pieData', :options='options')
    .tile.is-ancestor
      .tile.is-parent.is-6
        article.tile.is-child.box
          h4.title ANIMATED RADAR
          chart(:type="'radar'", :data='waveData', :options='options')
      .tile.is-parent.is-6
        article.tile.is-child.box
          h4.title ANIMATED BARS
          chart(:type="'bar'", :data='waveData', :options='options')
    .tile.is-ancestor
      .tile.is-parent.is-4
        article.tile.is-child.box
          h4.title RADAR
          chart(:type="'radar'", :data='seriesData', :options='options_3')
      .tile.is-parent.is-4
        article.tile.is-child.box
          h4.title LINE
          chart(:type="'line'", :data='seriesData', :options='options_3')
      .tile.is-parent.is-4
        article.tile.is-child.box
          h4.title BARS
          chart(:type="'bar'", :data='seriesData', :options='options_3')
</template>
